...
LOGO_LINKS = [
    ...
    "https://telegra.ph/file/09c98a7bad5b6e80e1e38.jpg",
    "https://telegra.ph/file/5db135848724f11281488.jpg",
    "https://telegra.ph/file/32b586f9713f640c1bd39.jpg",
    "https://telegra.ph/file/48fc2db877b27ee398200.jpg",
    "https://telegra.ph/file/507a45293257abd93e1aa.jpg",
    "https://telegra.ph/file/0065e7159b8a3dd984990.jpg",
    "https://telegra.ph/file/62e2d0556ea6175af90e2.jpg",
    "https://telegra.ph/file/381eac9b70f0cfe9ef642.jpg",
    "https://telegra.ph/file/783219916dafa0fc0356e.jpg",
...
async def lego(event):
    ...
    try:
        ...
        await telethn.send_file(
            event.chat_id, file=fname, caption=f"ʟᴏɢᴏ ɢᴇɴᴇʀᴀᴛᴇᴅ ʙʏ мαяк ✘ ʀᴏʙᴏᴛ"
        )
        await pesan.delete()
        if os.path.exists(fname):
            os.remove(fname)
    except Exception as e:
        await event.reply(f"ғʟᴏᴏᴅᴡᴀɪᴛ ᴇʀʀᴏʀ, ʀᴇᴩᴏʀᴛ ᴛʜɪs ᴀᴛ @craxymarrk")
